...
export default function TestEditorPage() {
  ...
  return (
    <div className="w-full bg-background overflow-y-auto">
      ...
      <div className="flex">
        <div className="flex-1 flex flex-col overflow-hidden border-r-2 border-sidebar-border relative min-h-full">
          <div className="border-b-2 border-sidebar-border h-12 bg-background px-5 flex items-end gap-6">
            <button
              onClick={() => setActiveTab('editor')}
              className={`pb-2.5 px-2.5 text-[13px] font-medium border-b-2 -mb-0.5 transition-colors ${activeTab === 'editor'
            ...
            <button
              ...
              className={`pb-2.5 px-2.5 text-[13px] font-medium border-b-2 -mb-0.5 transition-colors ${activeTab === 'yaml'
                ? 'border-white text-white'
                : 'border-transparent text-muted-foreground hover:text-foreground'
                }`}
            >
          ...
          <div className="flex-1 overflow-auto p-4 bg-background">
            {activeTab === 'editor' ? (
              <div className="space-y-3 w-full">
                <div className="flex justify-between w-full items-center gap-2.5 px-1.5">
                  <div className="flex items-center gap-2.5 w-[85%]">
                    <div className="flex items-center justify-center">
                      <Settings className="text-muted-foreground h-4 w-4" />
                    </div>
                    <div className="flex items-center rounded-xs gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800">
                      <span className="text-[13px] text-gray-300">extracted value</span>
                    </div>
                    <input
                      type="text"
                      placeholder="Variable name"
                      className="flex-1 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs text-[13px] text-muted-foreground placeholder:text-muted-foreground focus:outline-none"
                    />
                  </div>
                ...
                <div className="flex justify-between w-full items-start gap-2.5 px-1.5">
                  <div className="flex gap-2.5 w-[85%]">
                    <div className="flex items-start justify-center mt-1.5">
                      <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.5 14H3.5C3.36739 14 3.24021 13.9473 3.14645 13.8536C3.05268 13.7598 3 13.6326 3 13.5V2.5C3 2.36739 3.05268 2.24021 3.14645 2.14645C3.24021 2.05268 3.36739 2 3.5 2H9.5L13 5.5V13.5C13 13.6326 12.9473 13.7598 12.8536 13.8536C12.7598 13.9473 12.6326 14 12.5 14Z" stroke="#989899" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M9.5 2V5.5H13" stroke="#989899" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M6 8.5H10" stroke="#989899" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M6 10.5H10" stroke="#989899" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>

                    </div>
                    <div className="flex flex-col gap-1.5 w-full">
                      <div className="flex items-center justify-between gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border rounded-xs border-zinc-800 cursor-pointer hover:bg-[#252525] w-fit">
                        <span className="text-[13px] text-white">Click</span>
                  ...
                  <div className="w-4 h-4 rounded-full border border-green-500 flex items-center justify-center mt-1.5">
                    <Check className='h-2.5 w-2.5 text-green-500' />
                  </div>
                </div>

                <div className="flex bg-[#ffffff]/2 py-1.5 justify-between w-full items-start gap-2.5 px-1.5">
                  <div className="flex gap-2.5 w-[85%]">
                    <div className=" mt-1.5">
                      <Hand className="text-muted-foreground h-4 w-4" />
                    </div>
                    <div className="flex flex-col w-full gap-1.5">
                      <div className="flex items-center gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs cursor-pointer hover:bg-[#252525] w-fit">
                        <span className="text-[13px] text-white">Wait</span>
                        <ChevronDown size={12} className="text-muted-foreground" />
                      </div>
                      <div className="flex items-center gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs">
                        <span className="text-[13px] text-muted-foreground">Second to wait</span>
                  ...
                  <div className="flex items-center gap-0.5 mt-1.5">
                    <button className="p-1 hover:bg-[#252525] rounded transition-colors">
                  ...
                  <div className="flex gap-2.5 w-[85%]">
                    ...
                    <div className='flex flex-col gap-2.5 w-full'>
                      <input
                        ...
                        className="flex-1 w-full px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs text-[13px] text-muted-foreground placeholder:text-muted-foreground focus:outline-none"
                      />
                      <div className="space-y-2.5 w-full">
                        <div className="flex w-full gap-2.5">
                          ...
                          <div className="flex w-full">
                            ...
                            <div className="flex flex-col gap-1.5 w-9 shrink-0">
                              <div className="h-9 flex items-center">
                                <span className="text-[13px] text-muted-foreground">if</span>
                              </div>
                              <div className="h-9 flex items-center">
                                <Settings className="text-muted-foreground h-3.5 w-3.5" />
                              </div>
                              <div className="h-9 flex items-center">
                                <span className="text-[13px] text-muted-foreground">else</span>
                              </div>
                              <div className="h-9 flex items-center">
                                <Hand className="text-muted-foreground h-3.5 w-3.5" />
                              </div>
                            </div>
                            {/* Right column - inputs */}
                            <div className="flex flex-col gap-1.5 flex-1">
                              ...
                              <div className="flex items-center gap-1.5 h-9">
                                <div className="flex items-center gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs">
                                  <span className="text-[13px] text-white">extracted value</span>
                                </div>
                                <input
                                  type="text"
                                  placeholder="Variable name"
                              ...
                              <div className="flex items-center gap-1.5 h-9">
                                <div className="flex items-center gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs cursor-pointer hover:bg-[#252525]">
                                  <span className="text-[13px] text-white">Wait</span>
                                  <ChevronDown size={12} className="text-muted-foreground" />
                                </div>
                              </div>
                              <div className="flex items-center gap-1.5 h-9">
                                <div className="flex-1 flex items-center gap-1.5 px-2.5 py-2 bg-[#1a1a1a] border border-zinc-800 rounded-xs">
                                  <span className="text-[13px] text-muted-foreground">Second to wait</span>
                                  <div className="ml-auto">
                                    <ChevronsUpDown size={12} className="text-muted-foreground" />
                                  </div>
              ...
              <div className="text-muted-foreground text-[13px]">YAML view goes here</div>
            )}
          </div>

          <div className="absolute bottom-5 left-1/2 -translate-x-1/2 bg-[#1a1a1a] border border-border/40 px-1.5 py-1.5 flex items-center gap-0.5 shadow-lg">
            <button className="p-2 bg-[#6E4FFF] transition-colors">
              <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="p-2 bg-[#270C17] transition-colors">
              <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z" stroke="#A3285B" strokeWidth="0.833333" strokeMiterlimit="10" />
                <path d="M8 12C10.2091 12 12 10.2091 12 8C12 5.79086 10.2091 4 8 4C5.79086 4 4 5.79086 4 8C4 10.2091 5.79086 12 8 12Z" fill="#A3285B" stroke="#A3285B" strokeWidth="0.833333" strokeMiterlimit="10" />
              </svg>
        ...
        <div className="w-175 min-w-[50%] bg-background flex flex-col">
          <div className="px-5 py-3 flex h-12 items-center justify-between border-b-2 border-sidebar-border">
            ...
            <div className="flex items-center gap-1.5">
              <button className="flex items-center gap-1.5 px-1.5 rounded-xs py-1.5 bg-zinc-800 border border-zinc-700 hover:bg-secondary transition-colors text-foreground text-[13px]">
