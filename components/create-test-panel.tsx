...
export function CreateTestPanel({ isOpen, onClose }: CreateTestPanelProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-screen w-150 bg-background border-l border-zinc-800 shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
      ...
      >
        <div className="flex items-start justify-between p-6">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-zinc-800 border-2 border-zinc-800 transition-colors text-zinc-500"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[rgba(255, 255, 255, 0.04)] text-lg border border-zinc-800 text-zinc-400 placeholder-zinc-700 focus:outline-none focus:ring-1 focus:ring-zinc-700 rounded-xs"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-4 py-2 bg-[rgba(255, 255, 255, 0.04)]  text-lg border border-zinc-800 text-zinc-400 focus:outline-none appearance-none rounded-xs"
              >
            ...
            <div className="flex gap-3 items-center">
              <div className="relative flex-1">
                <select
                  ...
                  className="w-full px-4 py-2 bg-[rgba(255, 255, 255, 0.04)]  text-lg border border-zinc-800 text-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-700 appearance-none rounded-xs"
                >
              ...
              <button className="px-4 py-2 border border-zinc-800 text-gray-200 hover:bg-zinc-800 transition-colors whitespace-nowrap">
                New build
              </button>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[rgba(255, 255, 255, 0.04)]  text-lg border border-zinc-800 text-zinc-400 placeholder-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-700 rounded-xs"
            />
          </div>
        ...
        <div className="p-6 mt-auto">
          <button 
            className="w-full px-4 py-3 text-white rounded-xs bg-linear-to-b from-[#A36BFF] to-[#4E3EFF] text-lg transition-all hover:opacity-90"
          >
            Create test
          </button>
        </div>
