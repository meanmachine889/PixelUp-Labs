...
export function TestEditorPanel({ isOpen, onClose }: TestEditorPanelProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-[#0a0a0a] z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        {/* Header */}
        <div className="border-b border-border/40 bg-[#0a0a0a] sticky top-0 z-40">
          <div className="px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 px-4 py-2 bg-[#1a1a1a] border border-border/40 rounded-lg hover:bg-[#252525] transition-colors text-white text-sm">
                <Eye size={16} />
                Preview
              </button>
        ...
        <div className="flex h-[calc(100vh-80px)]">
          ...
          <div className="flex-1 flex flex-col overflow-hidden border-r border-border/40">
            {/* Tabs */}
            <div className="border-b border-border/40 bg-[#0a0a0a] px-6 flex items-center gap-8">
              <button
            ...
            <div className="flex-1 overflow-auto p-6 bg-[#0a0a0a]">
              {activeTab === 'editor' ? (
                <div className="space-y-4 max-w-xl">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-md bg-[#1a1a1a] border border-border/40 flex items-center justify-center">
                      <Settings size={14} className="text-muted-foreground" />
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#1a1a1a] border border-border/40 rounded-lg">
                      <span className="text-sm text-white">extracted value</span>
                    </div>
                    <input
                      type="text"
                      placeholder="Variable name"
                      className="flex-1 px-3 py-2 bg-[#1a1a1a] border border-border/40 rounded-lg text-sm text-muted-foreground placeholder:text-muted-foreground focus:outline-none focus:border-purple-500"
                    />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 bg-[#1a1a1a] border border-border/40 rounded-lg cursor-pointer hover:bg-[#252525]">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="ml-9 space-y-3">
                      ...
                      <div className="ml-9 flex items-center gap-3">
                        ...
                        <div className="flex-1 flex items-center gap-2 px-3 py-2 bg-[#1a1a1a] border border-border/40 rounded-lg">
                          <span className="text-sm text-muted-foreground">Second to wait</span>
                          <div className="ml-auto">
                            <ChevronDown size={14} className="text-muted-foreground" />
                          </div>
            ...
            {/* Bottom Toolbar */}
            <div className="border-t border-border/40 bg-[#0a0a0a] px-6 py-3 flex items-center justify-center gap-2">
          ...
          <div className="w-[500px] bg-[#0a0a0a] flex flex-col">
            {/* Playground Header */}
